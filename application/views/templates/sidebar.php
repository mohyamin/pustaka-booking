        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Looping Menu-->
                ...
                <li class="nav-item active">
                    <!--nav item Dahboard -->
                    <li class="nav-item">
                        <a class="nav-link pb-0" href="<?php echo base_url('pinjam'); ?>">
                            <i class="fa fa-fw fa-shopping-cart"></i>
                            <span>Data Peminjaman</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pb-0" href="<?php echo base_url('pinjam/daftarbooking'); ?>">
                ...
                <li class="nav-item active">
                    ...
                    <li class="nav-item">
                        <a class="nav-link pb-0" href="<?php echo base_url('laporan/laporan_pinjam'); ?>">
                            <i class="fa fa-fw fa-address-book"></i>
